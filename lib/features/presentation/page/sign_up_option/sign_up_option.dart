...
class SignUpPageOption extends StatefulWidget {
  const SignUpPageOption({Key? key}) : super(key: key);

  @override
  State<SignUpPageOption> createState() => _SignUpPageOptionState();
}

class _SignUpPageOptionState extends State<SignUpPageOption> {
